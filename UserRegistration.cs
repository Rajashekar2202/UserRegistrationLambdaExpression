...
namespace LambdaExpression
{
    public class UserRegistration
    {
        ...
        public static string RegexPassword3 = "^[A-Z]{1,}[a-z]{5,}[0-9]{1,}[@#&*]{1}$";
        public string validatePassword3usingLambda(string Password3) => Regex.IsMatch(Password3, RegexPassword3) ? "valid" : "Invalid";
